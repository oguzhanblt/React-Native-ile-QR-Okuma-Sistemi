...
export default class fatih extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
     ...
     >
       <MapViewDirections
       origin={{latitude: 41.016667,longitude: 28.933333}}
       ...
       title={'Ümraniye'}/>
       <Marker coordinate={{latitude: 41.016667,longitude: 28.933333}}
       title={'Fatih'}/>
     </MapView>
