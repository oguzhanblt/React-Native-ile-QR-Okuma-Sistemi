...
export default class florya extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
   ...
   render() {
    ...
    return (
     ...
     >
       <MapViewDirections
       origin={{latitude: 40.979752,longitude: 28.792860}}
       ...
       title={'Ümraniye'}/>
       <Marker coordinate={{latitude: 40.979752,longitude: 28.792860}}
       title={'Florya'}/>
     </MapView>
